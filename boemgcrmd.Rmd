...
# Define this early so it's available to all chunks
...
df_clean <- df_clean %>%
  mutate(
    ...
    # Fix century typos: 2093 --> 2023, 2094 --> 2024
    collection_date = case_when(
      format(collection_date, "%Y") == "2093" ~ collection_date - lubridate::years(70),
      format(collection_date, "%Y") == "2094" ~ collection_date - lubridate::years(70),
